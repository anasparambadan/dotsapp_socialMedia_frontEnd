...
//         case "OTP_SUCCESS":
//             localStorage.setItem("profile",JSON.stringify({...action?.data}))
//             return{...state,loading:false,authData:action.data, error:false,otpsuccess:true};
//         case "OTP_FAIL"  :
...
//         case "FOLLOW_USER"  :
//             return {...state, authData: {...state.authData, user:{...state.authData.user, following:[...state.authData.user.following, action.data]}} ,error:false};
//         case "UNFOLLOW_USER" :
